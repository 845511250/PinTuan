 ...
 */
public class StaffSendAdapter extends RecyclerView.Adapter<StaffSendAdapter.AnchorHotViewHolder> {
    private ArrayList<Staff> data;
    private Context context;
    LayoutInflater layoutInflater;

    public StaffSendAdapter(Context mContext, ArrayList<Staff> mData) {
        data = mData;
        context = mContext;
    ...
    public AnchorHotViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_rv_staff_send,
                parent, false);
    ...
    public void onBindViewHolder(final AnchorHotViewHolder holder, final int position) {
        ...
        holder.tv_activityNum.setText(staff.activityNum);
